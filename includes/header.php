<?php
// Activer la mise en tampon de sortie pour éviter l'erreur "headers already sent"
ob_start();
...
// Définir le rôle de l'utilisateur connecté
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center py-4">
                    ...
                    <a href="index.php" 
                        ...
                        <?php echo (!isset($_GET['page'])) ? 'border-b-2 border-primary' : ''; ?>">
                        Accueil
